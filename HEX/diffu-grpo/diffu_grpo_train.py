...
from data_utils import (
    ...
    get_arcc_questions,
    get_truthfulqa_questions,
    # get_truthfulqa_questions, # no existing train dataset for TruthfulQA !!!!!
...
def main(grpo_config, model_config):
    ...
    elif grpo_config.dataset == "arcc":
        dataset = get_arcc_questions("train")
        reward_functions = [
            correctness_reward_func_math,
            boxed_and_answer_tags_format_reward,
        ]
    elif grpo_config.dataset == "truthfulqa":
        dataset = get_truthfulqa_questions()
        print('truthfulqa train')
        reward_functions = [
            correctness_reward_func_math,
            boxed_and_answer_tags_format_reward,
        ]
    ...
    if grpo_config.dataset in ["countdown", "sudoku", 'hellaswag']:
